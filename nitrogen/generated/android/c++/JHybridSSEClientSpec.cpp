...
namespace margelo::nitro::nitrosseclient {
  ...
  // Methods
  void JHybridSSEClientSpec::connect(const std::string& url, const std::optional<std::unordered_map<std::string, std::string>>& headers, const std::optional<SSESessionOptions>& session, const std::optional<SSEReconnectOptions>& reconnect, const std::optional<std::string>& method, const std::optional<std::string>& body, std::optional<bool> validateContentType) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<void(jni::alias_ref<jni::JString> /* url */, jni::alias_ref<jni::JMap<jni::JString, jni::JString>> /* headers */, jni::alias_ref<JSSESessionOptions> /* session */, jni::alias_ref<JSSEReconnectOptions> /* reconnect */, jni::alias_ref<jni::JString> /* method */, jni::alias_ref<jni::JString> /* body */, jni::alias_ref<jni::JBoolean> /* validateContentType */)>("connect");
    method(_javaPart, jni::make_jstring(url), headers.has_value() ? [&]() -> jni::local_ref<jni::JMap<jni::JString, jni::JString>> {
      ...
      return __map;
    }() : nullptr, session.has_value() ? JSSESessionOptions::fromCpp(session.value()) : nullptr, reconnect.has_value() ? JSSEReconnectOptions::fromCpp(reconnect.value()) : nullptr, method.has_value() ? jni::make_jstring(method.value()) : nullptr, body.has_value() ? jni::make_jstring(body.value()) : nullptr, validateContentType.has_value() ? jni::JBoolean::valueOf(validateContentType.value()) : nullptr);
  }
